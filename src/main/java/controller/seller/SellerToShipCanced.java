...
@WebServlet("/seller-to-ship-cancelled")
public class SellerToShipCanced extends HttpServlet {
    @Override
...
//        4 là trạng thái của mặt đã hủy
        list = orderItemDao.listOrderItemByShopId(shopId, 4, 2);
