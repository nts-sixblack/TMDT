...
@WebServlet("/seller-to-ship-delivering")
public class SellerToShipDelivering extends HttpServlet {
    @Override
...
//        2 là trạng thái của mặt hàng đã giao cho bên vận chuyển
//        2 là trạng thái của đơn hàng đang giao
        list = orderItemDao.listOrderItemByShopId(shopId, 2, 2);
        /////
        List<OrderItem> list1 = new ArrayList<OrderItem>();
//        5 là trạng thái của mặt hàng đã giao cho bên vận chuyển
//        5 là trạng thái của đơn hàng đang giao
        list1 = orderItemDao.listOrderItemByShopId(shopId, 5, 2);
        list.addAll(list1);
