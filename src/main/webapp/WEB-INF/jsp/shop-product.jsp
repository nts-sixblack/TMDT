...
<%--                <button>Liên hệ</button>--%>
        ...
        <div class="shop-store">
            <div class="shop-description">
                ...
                <div class="content">
                    <h4>@SHOPNAME</h4>
                    <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Hic optio distinctio mollitia minima. Iusto a animi cumque dolore laudantium. Id, illo tempora aliquam reprehenderit blanditiis qui veritatis eveniet quidem esse, libero
                        enim iure quam laudantium ullam nostrum saepe sapiente excepturi.</p>
                </div>
            </div>
